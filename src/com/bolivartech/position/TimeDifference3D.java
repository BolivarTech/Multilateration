 ...
 *
 *   This Class is the Valhala Networks's 3D Time Difference equation Class.<br/><br/>
 *
 *   Esta clase implementa la definicion de la ecuacion para la diferencia de tiempo de llegada en 3 dimensiones.<br/><br/><br/><br/>
 *
 *   <br/><br/>
 *
 ...
 * @version 1.0.0
 */
public strictfp class TimeDifference3D extends NAFunction  {
    double SignalSpeed;
    double TimeDiff;
    double TimeDiff1;
    double Xp,Yp,Zp;
     ...
     */
    public TimeDifference3D(double Xp, double Yp, double Zp, double X1, double Y1, double Z1) {
        this.Xp = Xp;
        this.Yp = Yp;
        this.Zp = Zp;
        this.X1 = X1;
     ...
     * @param Z1  Difecencia del Triangulador1 alturas respecto al pibote en metros
     */
    public TimeDifference3D(double SignalSpeed, double TimeDiff, double Xp, double Yp, double Zp,double TimeDiff1, double X1, double Y1, double Z1) {
     ...
     * @param Z1  Difecencia del Triangulador1 alturas respecto al pibote en metros
     */
    public TimeDifference3D(double TimeDiff, double Xp, double Yp, double Zp,double X1, double Y1, double Z1) {
    ...
    /**
     * Retorna la difecencia de alturas respecto al pibote en metros.<br/><br/>
     * 
     * @return Difecencia de alturas respecto al pibote en metros
     */
    public double getZp() {
        return Zp;
    }
    ...
    /**
     * Establece la difecencia de alturas respecto al pibote en metros.<br/><br/>
     * 
     * @param Zp Difecencia de alturas respecto al pibote en metros
     */
     ...
     * Establece la difecencia de alturas respecto al pibote en metros.<br/><br/>
     * 
     * @param Z1 Difecencia de alturas respecto al pibote en metros
     */
    ...
    public double Eval(double[] x) throws UtilsException {
        ...
        Cm=((2*this.Zp)/(this.SignalSpeed*this.TimeDiff))-((2*this.Z1)/(this.SignalSpeed*this.TimeDiff1));
        Dm=(this.SignalSpeed*this.TimeDiff)-(this.SignalSpeed*this.TimeDiff1)-((Math.pow(this.Xp,2)+Math.pow(this.Yp,2)+Math.pow(this.Zp,2))/(this.SignalSpeed*this.TimeDiff))+((Math.pow(this.X1,2)+Math.pow(this.Y1,2)+Math.pow(this.Z1,2))/(this.SignalSpeed*this.TimeDiff1));
        return x[0]*Am+x[1]*Bm+x[2]*Cm+Dm;
